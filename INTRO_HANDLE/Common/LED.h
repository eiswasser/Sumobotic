 ...
 * If the board is ROBO LED1 is the ........
 */
#if PL_NOF_LED >= 1
	#include "LED_green.h"
	...
	#define LED1_Get()		(0)				 		/*! Return TRUE, if LED1 is on, FALSE otherwise */
 ...
 * If the board is ROBO LED2 is the ........
 */
#if PL_NOF_LED >= 2
	#include "LED_red.h"
	...
	#define LED2_Get()		(0)				 		/*! Return TRUE, if LED2 is on, FALSE otherwise */
